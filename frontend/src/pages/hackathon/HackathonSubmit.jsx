...
const HackathonSubmit = () => {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      if (problemId) fd.append("problemId", String(problemId));
      fd.append("title", customTitle || selectedProblem?.title || "");
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div>
              <label className="text-sm font-medium text-gray-800">
                {problems.length > 0 ? "Problem" : "Problem Title / Topic *"}
              </label>
              {problems.length > 0 ? (
                <>
                  <select
                    ...
                    required
                    className="mt-2 w-full rounded-xl border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm"
                    disabled={!canSubmit}
                  >
                ...
                <input
                  ...
                  placeholder="Enter your problem statement / project topic..."
                  className="mt-2 w-full rounded-xl border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm"
                  disabled={!canSubmit}
                />
              )}
